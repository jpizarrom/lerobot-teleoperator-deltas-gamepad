...
class DeltasGamepad(Teleoperator):
    config_class = DeltasGamepadConfig
    name = "deltas_gamepad"

    def __init__(self, config: DeltasGamepadConfig):
    ...
    def connect(self) -> None:
        ...
        if sys.platform == "darwin":
            ...
            raise NotImplementedError(
                "HIDAPI support not implemented yet for deltas_gamepad"
            )
        else:
    ...
    def get_action(self) -> dict[str, Any]:
        ...
        gamepad_action = np.array(
            [delta_x, delta_y, delta_z, delta_wx, delta_wy, delta_wz], dtype=np.float32
        )
        ...
        action_dict = {
            ...
            "delta_wx": gamepad_action[3],
            "delta_wy": gamepad_action[4],
    ...
    def reset(self) -> None:
        ...
        if self.gamepad is not None and hasattr(self.gamepad, "reset"):
            self.gamepad.reset()
